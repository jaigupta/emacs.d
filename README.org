...
[[https://github.com/jwiegley/use-package][use-package]] provides a macro to lazily require/include packages or files. It
also provides a macro to auto-install packages on demand.
...
#+begin_src emacs-lisp
  (use-package paradox
    ...
    :init (bw/add-launcher "p" 'paradox-list-packages)
    :config
...
#+begin_src emacs-lisp
  (use-package magit
    :commands (magit-status magit-grep)
...
#+begin_src emacs-lisp
  (use-package ido-vertical-mode
    ...
    :config (setq ido-max-prospects 5)
...
#+begin_src emacs-lisp
  (use-package magit-find-file
    ...
    :bind (("C-c t" . magit-find-file-completing-read)
           ("M-p" . magit-find-file-completing-read)
           ("s-p" . magit-find-file-completing-read))
    :init (bw/add-launcher "t" #'magit-find-file-completing-read)
...
#+begin_src emacs-lisp
  (use-package smartparens
    ...
    :idle (use-package smartparens-config
...
#+begin_src emacs-lisp
  (use-package flycheck
    ...
    :init (setq flycheck-indication-mode nil)
    :ensure flycheck)
#+end_src
...
#+begin_src emacs-lisp
  (use-package web-mode
    :commands web-mode
    :mode "\\.\\(html\\|html\\.erb\\|mustache\\|jinja\\|php\\)\\'"
...
#+begin_src emacs-lisp
  (use-package idomenu
    :commands idomenu
    :init (bw/add-launcher "i" 'idomenu)
